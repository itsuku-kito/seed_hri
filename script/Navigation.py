...
class NavigationService:
    def __init__(self,robotname):
        ...
        self.move_seed = rospy.ServiceProxy('/navigation_seed_noid', MoveCommunication)
    ...
    def monitor_playback(self):
        ...
        try:
            #service = self.motion("Navigation1")
    ...
    def component_status(self, req):
        # 現在の状態を返答
        if (req.component_name == "Navigation"):
...
if __name__ == "__main__":
    ...
    node_name = robot + '_Navigation'
  
    rospy.init_node(node_name)
    service = NavigationService(robotname)
    service.run()